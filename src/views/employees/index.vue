<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column :label="$t('table.employee')" width="110px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="$t('table.sex')" width="70px" align="center">
        <template slot-scope="scope">
          <span>{{ $t(scope.row.sex.toLowerCase()) }} </span>
        </template>
      </el-table-column>
      <el-table-column :label="$t('table.ic')" width="220px" align="center">
        <template slot-scope="scope">
